  ...
  return (
    <section id="get-started" className="relative overflow-hidden bg-ration-orange px-gutter py-section text-ration-dark" aria-labelledby="cta-title">
      ...
      <div className="relative mx-auto max-w-content">
        ...
        <h2 id="cta-title" className="display-type section-title max-w-[12ch]">Put a hard limit on software.</h2>
        <p className="hand-type mt-5 text-2xl mobile:text-3xl">Money, but with boundaries.</p>
